...
public class PartKitServiceImpl implements PartKitService {
	...
	public String addPartKitTemplate(PartKitTemplate partKitParam, InforContext context) throws InforException {
		...
		if (context.getCredentials() != null) {
			inforws.addKitTemplateOp(addKitTemplate, applicationData.getOrganization(), tools.createSecurityHeader(context),"TERMINATE", null, null, applicationData.getTenant());
		} else {
	...
	public String createKitSession(BuildKitParam buildKitParam, InforContext context) throws InforException{
		...
		if (context.getCredentials() != null) {
			r = inforws.createKitSessionOp(kitSessionMsg, applicationData.getOrganization(), tools.createSecurityHeader(context),"TERMINATE", null, null, applicationData.getTenant());
		} else {
	...
	public String buildKit(String kitSessionId, InforContext context) throws InforException{
		...
		if (context.getCredentials() != null) {
			createKitResult = inforws.createKitOp(createKitMsg, applicationData.getOrganization(), tools.createSecurityHeader(context),"TERMINATE", null, null, applicationData.getTenant());
		} else {
