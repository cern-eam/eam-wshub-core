...
public enum EAM_OPERATION {
    ...
    MEC_SYNC("MEC_SYNC"),
    MEC_GET_EAM("MEC_GET_EAM"),

    CONTRACTTEMPLATE_CREATE("CONTRACTTEMPLATE_C"),
    CONTRACTTEMPLATE_READ("CONTRACTTEMPLATE_R"),
    CONTRACTTEMPLATE_READ_DEFAULT("CONTRACTTEMPLATE_RD"),
    CONTRACTTEMPLATE_UPDATE("CONTRACTTEMPLATE_U"),
    CONTRACTTEMPLATE_DELETE("CONTRACTTEMPLATE_D"),

    CHARGEDEFINITION_CREATE("CHARGEDEFINITION_C"),
    CHARGEDEFINITION_READ("CHARGEDEFINITION_R"),
    CHARGEDEFINITION_READ_DEFAULT("CHARGEDEFINITION_RD"),
    CHARGEDEFINITION_UPDATE("CHARGEDEFINITION_U"),
    CHARGEDEFINITION_DELETE("CHARGEDEFINITION_D"),
