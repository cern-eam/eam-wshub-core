...
public class DocumentsServiceImpl implements DocumentsService {
	...
	public String createInforDocument(InforDocument doc, InforContext context)
		...
		MP6001_AddDocument_001_Result result = inforws.addDocumentOp(addDoc, applicationData.getOrganization(), tools.createSecurityHeader(context),"TERMINATE", null, tools.createMessageConfig(), applicationData.getTenant());
	...
	public String createInforDocumentAssociation(String document, String entity, String objectCode, InforContext context)
		...
		MP0112_AddDocumentAssociation_001_Result result = inforws.addDocumentAssociationOp(addDocAssoc, applicationData.getOrganization(), tools.createSecurityHeader(context),"TERMINATE", null, tools.createMessageConfig(), applicationData.getTenant());
