...
public enum INFOR_OPERATION {
    ...
    // SAFETIES
    SAFETY_ADD("SAFETY_ADD"),
    SAFETY_ADD_MULTIPLE("SAFETY_ADD_MULTIPLE"),
    SAFETY_DELETE("SAFETY_DELETE"),
    SAFETY_ADD_BATCH("SAFETY_ADD_BATCH"),
    SAFETY_DELETE_BATCH("SAFETY_DELETE_BATCH"),
    SAFETY_GET("SAFETY_GET"),
    SAFETY_GET_BATCH("SAFETY_GET_BATCH"),
    SAFETY_SYNC("SAFETY_SYNC"),
    SAFETY_GET_LIST("SAFETY_GET_LIST"),
