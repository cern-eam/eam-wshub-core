...
public class EquipmentMeterReadingServiceImpl implements EquipmentMeterReadingService {
    ...
    public EquipmentMeterReadingServiceImpl(ApplicationData applicationData, Tools tools, EAMWebServicesPT eamWebServicesToolkitClient) {
    ...
    @Override
    public String createEquipmentMeterReading(final EAMContext context, final EqpMeterReading eqpMeterReading,
        ...
        final EquipmentMeterReading equipmentMeterReading =
                tools.getEAMFieldTools().transformWSHubObject(new EquipmentMeterReading(), eqpMeterReading, context);
        ...
        final MP9134_AddEquipmentMeterReading_001_Result mp9134_addEquipmentMeterReading_001_result = tools.performEAMOperation(context, eamws::addEquipmentMeterReadingOp, addEquipmentMeterReading_001);

        return mp9134_addEquipmentMeterReading_001_result.getResultData().getEQUIPMETERID().getSTANDARDENTITYCODE();
    }

    @Override
    public EqpMeterReading readEquipmentMeterReading(final EAMContext context, String readingCode) throws EAMException {
        final EquipmentMeterReading equipmentMeterReading = readEquipmentMeterReadingInternal(context, readingCode);
        final EqpMeterReading eqpMeterReading = tools.getEAMFieldTools().transformEAMObject(new EqpMeterReading(), equipmentMeterReading, context);
        return eqpMeterReading;
    }

    private EquipmentMeterReading readEquipmentMeterReadingInternal(final EAMContext context, String readingCode) throws EAMException {
        ...
        final MP9132_GetEquipmentMeterReading_001_Result mp9132_getEquipmentMeterReading_001_result = tools.performEAMOperation(context, eamws::getEquipmentMeterReadingOp, getEquipmentMeterReading_001);
    ...
    @Override
    public String updateEquipmentMeterReading(final EAMContext context, final EqpMeterReading eqpMeterReading) throws EAMException {
        ...
        final EquipmentMeterReading equipmentMeterReading = tools.getEAMFieldTools().transformWSHubObject(equipmentMeterReadingInternal,
        ...
        final MP9135_SyncEquipmentMeterReading_001_Result mp9135_syncEquipmentMeterReading_001_result = tools.performEAMOperation(context, eamws::syncEquipmentMeterReadingOp, mp9135_syncEquipmentMeterReading_001);
        return mp9135_syncEquipmentMeterReading_001_result.getResultData().getEQUIPMETERID().getSTANDARDENTITYCODE();
    }

    @Override
    public String deleteEquipmentMeterReading(final EAMContext context, final String readingCode) throws EAMException {
        ...
        final MP9136_DeleteEquipmentMeterReading_001_Result mp9136_deleteEquipmentMeterReading_001_result =
                tools.performEAMOperation(context, eamws::deleteEquipmentMeterReadingOp, mp9136_deleteEquipmentMeterReading_001);
        return mp9136_deleteEquipmentMeterReading_001_result.getResultData().getEQUIPMETERID().getSTANDARDENTITYCODE();
    }

    @Override
    public EqpMeterReading readEquipmentMeterReadingDefault(final EAMContext context, final EqpMeterReading eqpMeterReading) throws EAMException {
        ...
        final MP9133_GetEquipmentMeterReadingDefault_001_Result mp9133_getEquipmentMeterReadingDefault_001_result = tools.performEAMOperation(context, eamws::getEquipmentMeterReadingDefaultOp, mp9133_getEquipmentMeterReadingDefault_001);
        ...
        final EqpMeterReading equipmentMeterReading =
                tools.getEAMFieldTools().transformEAMObject(new EqpMeterReading(), equipmentMeterReadingDefault, context);
        return equipmentMeterReading;
    }
}
