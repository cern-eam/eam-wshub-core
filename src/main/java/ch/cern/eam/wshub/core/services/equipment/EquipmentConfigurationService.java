...
public interface EquipmentConfigurationService {
    ...
    EquipmentConfigurationEntity readEquipmentConfiguration(InforContext context, String equipmentConfigurationCode, String revisionNum) throws InforException;
